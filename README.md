...
## author, url, publishedAt 추가하고 앱 스토어 출시
```
author, url, publishedAt 데이터를 추가로 받아오고 이를 출력하게끔 수정한 후
UI를 보기 쉽게 수정한 후에 앱 스토어에 출시(2023.03.01) ('한국을 보는 작은 창')

테스트 결과 API가 제공하는 description 부분이 한국 headline News에는 제공되지 않음(null)을 확인 
url을 클릭했을 때 옳지 않거나, 버그가 발생하는 경우가 생김
```
![image](https://user-images.githubusercontent.com/58906858/222086511-2ca6f5d1-3142-41db-99f2-ab9bdedca930.png)
